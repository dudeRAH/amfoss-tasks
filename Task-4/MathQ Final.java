...
import java.awt.Font; //first error-import statement
...
public class MathQuiz extends JFrame {
    ...
    ButtonGroup levelGroup = new ButtonGroup(); //second error-absence of semicolon

    //labels
    JLabel questionLabel = new JLabel("Question:"); //third error-faulty capital in function
    ...
    //jbuttons
    JButton startButton = new JButton("Start"); //fourth and fifth errors-faulty logic
    ...
    public MathQuiz() {
        ...
        //creating panels
        JPanel panel1 = new JPanel(); //sixth error-missing function brackets // types + levels
        ...
        panel31.setBorder(new TitledBorder("Correct Count")); //seventh error-missing semicolon
